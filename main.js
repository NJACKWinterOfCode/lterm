...
jQuery(document).ready(function($) 
{
    ...
    var arr2 = ['echo','pwd','ls','cd','cd ..','cd ~','cat','touch','cp','rm','mkdir','clear','uname','date','ifconfig','tty','whoami','history'];
    ...
    $('body').terminal({
        help: function() {
            ...
            this.echo('> whoami --------- ' + task[arr[16]]);
            this.echo('> history -------- ' + task[arr[17]]);
            this.echo('\n');
        },
        echo: function(arg1) {
            arr[0] = 1;
        ...
        whoami: function() {
            arr[16] = 1;
            this.echo('lterm\n');
            this.echo('> The [[b;#ff3300;]whoami] command prints the user name associated with current effective user id.');
            this.echo('> Type [[b;#ff3300;]help] and check that this task is completed.\n');
        },
